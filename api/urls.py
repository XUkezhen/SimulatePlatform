...
path('connect/', SocketView.as_view(), name='connect'),
    ...
    path('api/getChannelNames', views.get_channel_names, name='get_channel_names'),
    ...
    path('api/uploadSceneStaticRoute', views.upload_scene_static_route, name='upload_scene_static_route'),
