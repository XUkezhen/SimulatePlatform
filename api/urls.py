...
path('connect/', SocketView.as_view(), name='connect'),
    ...
    path('api/configureProtocol/<int:node_id>/<int:interface_index>/', views.configure_protocol, name='configure_protocol'),
    path('api/getInterfaceConfig/<int:node_id>/<int:interface_index>/', views.get_interface_config,
